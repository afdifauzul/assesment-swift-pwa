    ...
    return (
        <>
            <form className={styles.container} onSubmit={formik.handleSubmit}>
                <Typography variant="h1" component="h1" style={{ fontWeight: 600, alignSelf:"center" ,fontFamily:'PTSans'}}>
                    {t('register:title')}
                </Typography>
                    ...
                    <div className={styles.ContactInformation}>
                        ...
                        <div className={styles.footer}>
                            <FormControlLabel
                                ...
                                style={{ marginBottom: enableRecaptcha ? 25 : 0 , justifyContent:"end"}}
                            />
                            ...
                            >
                                <Typography variant="span" type="bold" letter="uppercase" color="white" style={{fontFamily:'PTSans'}}>
                                    {t('register:button')}
                                </Typography>
                            </Button>
                        </div>
